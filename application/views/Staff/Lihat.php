          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                  <a class="btn btn-remove pull-right mb hp" href="<?=site_url('staff/absen')?>"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Kembali</a>
  ...
  <tr>
   <td align="center">
    <span style="line-height: 1.6; font-weight: bold;">
     ...
     <br>TINGKAT SD BULAN <?php echo $bulann; ?> TAHUN <?php echo $tahun; ?>
    </span>
   </td>
  </tr>
