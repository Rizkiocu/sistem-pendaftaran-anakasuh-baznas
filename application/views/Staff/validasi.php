                   ...
                   <?php 
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;">
                        ...
                        <a href="#val<?php echo $s->nisn;?>" data-toggle="modal" class="btn btn-block btn-success btn-sm">Validasi</a>
                      </td>
                    </tr>
                    <?php } ?>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="<?php echo base_url('staff/siswa/validasi'); ?>" method="post" >
                  <p>Apakah anda yakin ingin mengubah Status ini menjadi Aktif?</p>
...
<?php foreach ($siswa as $s) { ?>
                ...
                <!-- /.box-header -->
                <form action="<?php echo base_url('umum/siswa/update'); ?>" method="post" >
                <div class="box-body">
                  <div class="row">
                    <div class="col-md-2">
