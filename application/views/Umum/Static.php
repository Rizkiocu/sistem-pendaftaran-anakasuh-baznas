        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu dropdown-usermenu pull-right" style=" width: 60px">
                    <li style="margin: 10px"><a href="<?php echo base_url('umum/datapribadi/profile')?>"> Profile</a></li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree" style="font-size: 16px">
        ...
        <li class="">
          <a href="<?php echo base_url('umum/siswa') ?>">
        ...
        <li class="">
          <a href="<?php echo base_url('umum/beasiswa') ?>">
